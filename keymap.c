...
uint16_t xz_layer_base[] = {
	...
	XZ_CLMK, KC_NO, KC_LALT, KC_LEFT, KC_UP,
	...
	KC_DOWN, KC_RIGHT, KC_LALT, KC_NO, XZ_LAY3,
...
uint16_t xz_layer_2[] = {
	...
	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	KC_NO, KC_NO, KC_NO, KC_QUOTE, KC_DQUO,
	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	KC_NO, KC_NO, KC_CIRC, KC_NO, KC_NO, KC_NO, KC_NO,
	KC_NO, KC_AMPR, KC_NO, KC_NO, KC_NO, KC_NO,
	KC_NO, KC_NO, KC_ASTR, KC_MINUS, KC_UNDS, KC_LCBR, KC_RCBR,
	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LPRN, KC_RPRN,
};
